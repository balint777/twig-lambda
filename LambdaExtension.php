...
class LambdaExtension extends \Twig\Extension\AbstractExtension
{
        ...
        return [
            ...
            [
                ...
                ';' => [
                    ...
                    'associativity' => \Twig\ExpressionParser::OPERATOR_RIGHT
                ],
            ]
        ];
    }
    ...
    {
        return [
            new \Twig\TwigFunction('call', '\DPolac\TwigLambda\LambdaExtension::call'),
        ];
    }
    ...
    {
        return [
            new \Twig\TwigTest('every', '\DPolac\TwigLambda\LambdaExtension::every'),
            new \Twig\TwigTest('any', '\DPolac\TwigLambda\LambdaExtension::any'),
        ];
    }
    ...
    {
        return [
            new \Twig\TwigFilter('unique_by', '\DPolac\TwigLambda\LambdaExtension::uniqueBy'),
            new \Twig\TwigFilter('group_by', '\DPolac\TwigLambda\LambdaExtension::groupBy'),
            new \Twig\TwigFilter('sort_by', '\DPolac\TwigLambda\LambdaExtension::sortBy'),
            new \Twig\TwigFilter('count_by', '\DPolac\TwigLambda\LambdaExtension::countBy'),
        ];
    }
